...
st.set_page_config(page_title="Ligações 3CX", layout="wide")
st.title("Relatório de Ligações 3CX")
...
escolha = st.sidebar.selectbox("Relatório:", [os.path.basename(f) for f in arquivos])
caminho = os.path.join(RELATORIOS_PATH, escolha)
